        ...
        >
          <div className="flex items-start gap-3 rounded-lg border border-blue-500/30 bg-zinc-900/95 px-3 py-2.5 shadow-lg ring-1 ring-blue-500/20 backdrop-blur-sm">
            ...
            <div className="min-w-0 flex-1 text-left">
              <p className="text-ui-xs font-medium text-zinc-100">Recover autosaved draft?</p>
              <p className="mt-0.5 text-[10px] leading-snug text-zinc-500">
                Saved {formatDraftTime(pendingDraft.savedAt)} · {pendingDraft.canvasWidth}×
                {pendingDraft.canvasHeight} · {pendingDraft.layers.length} layer
