...
import { buildEditorDraft, type DraftSourceState } from '@/lib/cache/buildDraft'
import {
  clearEditorDraft,
...
export type DraftCacheStatus = 'idle' | 'saving' | 'saved' | 'unavailable' | 'error'
...
export function useEditorDraftCache(
  ...
  const [pendingDraft, setPendingDraft] = useState<EditorDraftCache | null>(null)
